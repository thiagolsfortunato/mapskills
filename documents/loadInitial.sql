...
INSERT INTO `alternative` VALUES (1,'Me tornar presidente desta Rede.',0,1),(2,'Abrir minha propria franquia.',2,1),(3,'Planejo continuar gerenciando esta pizzaria.',5,1),(4,'Usar as experiências adquiridas aqui para abrir o próprio negócio',1,1),(5,'Deixar os sabores mais simples, porém aumentar a quantidade de recheio.',1,2),(6,'Fazer uma pesquisa local entre os cidadãos locais.',4,2),(7,'Seguir o padrão da concorrencia.',4,2),(8,'Usar o feedback dos clientes para decidir.',6,2),(9,'Renegociar os preços com os fornecedores.',6,3),(10,'Pesquisar novos fornecedores de nível superior',6,3),(11,'Pesquisar fornecedores mais baratas.',6,3),(12,'Diminuir tamanho da pizza',5,3),(13,'Contrata um atendente experiente, para suprir a demanda e coordenar a equipe.',0,4),(14,'Faz um programa de treinamento, supervisionado pessoalmente.',5,4),(15,'Discutir o problema pessoalmente com cada atendente.',6,4),(16,'Implementar um sistema de cotas de vendas diárias com bonificação.',4,4),(17,'Contratar mais um motoboy.',1,5),(18,'Aumentar o tempo de entrega.',0,5),(19,'Comprar outra moto mais potente.',1,5),(20,'Agilizar a cozinha dando o tempo necessário ao motoboy.',6,5),(21,'(Cutuca)Não é bom dormir em serviço.',2,6),(22,'(Bate na mesa)Não quero que isso se repita.',2,6),(23,'Cutuca o funcionário.',3,6),(24,'Acorde, vá dormir na sua casa, quero que venha trabalhar direito amanhã',2,6),(25,'Criar um serviço de entregas online.',3,7),(26,'Criar promoções para pedidos específicos.',1,7),(27,'Baratear o preço da entrega.',4,7),(28,'Aumentar os preços.',0,7),(29,'Observar a situação a distância',6,8),(30,'Perguntar o que está acontecendo',4,8),(31,'Pedir para outro funcionário verificar a situação',6,8),(32,'Ignora e vai tratar de outro assunto',3,8),(33,'Desculpe senhor, gostaria de trocar a pizza?',1,9),(34,'Por favor senhor, poderia sair da fila, podemos conversar em outro lugar.',6,9),(35,'(chama um funcionário) tente resolver isso para mim.',3,9),(36,'Desculpe senhor, o que podemos fazer para nos desculpar.',6,9),(37,'Manter a posição e continuar investindo no projeto',1,10),(38,'Reduzir o orçamento do projeto',2,10),(39,'Abortar o projeto',1,10),(40,'Postergar o projeto',4,10),(41,'Teu aumento já está agendado para uma data futura, no momento isto é inviável.',3,11),(42,'Talvez em uma data futura possamos negociar um aumento mais condizente com a situação da empresa.',4,11),(43,'Me desculpe, mas não será possível com a situação atual da empresa.',4,11),(44,'As últimas mudanças na empresa tornaram difícil a entrega de tal beneficio sem um planejamento prévio.',2,11),(45,'Compre mais ingredientes, vamos improvisar até você chegar!',5,12),(46,'Digam que vamos servir as sobremesas (é o que ainda está com uma boa quantidade)',4,12),(47,'Vamos improvisar com o que temos mesmo.',5,12),(48,'Peça para os fornecedores trazerem os ingredientes o mais rápido possivel!',0,12),(49,'Vamos abaixar o preço das pizzas',2,13),(50,'Vamos dominar a entrega de pizzas, fazendo promoções acima de preço X',6,13),(51,'Extras para quem comprar pizzas por um tempo predeterminado.',2,13),(52,'Contratar um serviço de publicidade.',3,13),(53,'Planeje as entrevistas para o sábado às 15h',4,14),(54,'Espalhe pela cidade informações sobre as vagas de emprego, conforme chegarem faremos as entrevistas',1,14),(55,'Coloque no panfleto: marquem hora para as entrevistas',0,14),(56,'Marque no panfleto que estarei esperando entrevistas às 15h todos os dias.',4,14),(57,'Ampliar a área física do estoque reduzindo a área de lazer dos funcionários',2,15),(58,'Criar um estoque secundário externo a instalação principal.',3,15),(59,'Comprar ingredientes de acordo com a sua rotatividade para diminuir espaço físico ocupado',5,15),(60,'Chamar os fornecedores duas vezes por dia',5,15),(61,'Coloco mais recheio nas pizzas',2,16),(62,'Diminui o preço da pizza por um tempo para ter menos prejuízo.',4,16),(63,'Aumenta o tamanho da pizza por um tempo.',1,16),(64,'Promoção! Ganhe um brotinho na compra de uma pizza grande.',0,16),(65,'(Sussurro no telefone) Façam o possível, agora estou em uma reunião.(desliga o telefone)<br /> Parece que houve um assalto na pizzaria, providencias estão sendo tomadas',1,17),(66,'(Sussurra no telefone) Depois eu cubro as despezas',4,17),(67,'(Sussurra no telefone) Façam o B.O., depois da reunião eu resolvo o resto<br />(Continua a reuniao...)',5,17),(68,'Parece que houve um assalto na pizzaria, Tenho que fazer o B.O. o mais rápido possivel. Podemos remarcar a Reunião?',6,17),(69,'Vou contratar seguranças para que não se repita.',4,18),(70,'Instalarei cameras por todas as partes.',3,18),(71,'Colocarei alarmes.',0,18),(72,'Vou incrementar a segurança com tudo possivel, cameras, alarmes e seguranças.',1,18),(73,'Aproveitaremos o ocorrido para fazer reformas que ajudarão na segurança de todos.',1,19),(74,'De jeito nenhum, nossa equipe estará a serviço assim que forem feitas reformas.',4,19),(75,'Após um breve descanso da equipe, voltaremos com força total.',0,19),(76,'Não necessariamente.',3,19),(77,'Aviso: reforma, voltamos em breve.',2,20),(78,'Fechado para reforma.',6,20),(79,'Retornamos em breve.',5,20),(80,'REFORMA! voltamos dia X.',6,20),(81,'Reuniao geral)- Mostrar a todos as mudanças implementadas.',5,21),(82,'Avisar a todos que o bandido está preso.',5,21),(83,'O que acham das Alterações?',1,21),(84,'(Fingir que nada aconteceu)',0,21),(85,'Implementar trabalho transacional de 3 dias para se adequar aos poucos a rotina.',0,22),(86,'(Acompanha-lo e auxilia-lo de perto algumas horas por dia.)',4,22),(87,'(Dá um descanço para ele.)',0,22),(88,'(Pedir para que ele se recomponha.)',6,22),(89,'Comprar materiais novos para o(a) sucessor(a).',2,23),(90,'Deixar o dinheiro como fundo emergencial para a pizzaria.',4,23),(91,'Pagar alguem para fazer um relatorio completo sobre o periodo.',2,23),(92,'Continuar na rotina normal, e entregar um relatorio padrão.',6,23),(93,'Organiza a equipe para receber o novo gerente.',2,24),(94,'Deixa uma lista de afazeres preparada para o sucessor.',5,24),(95,'Se foca no dia a dia para manter a pizzaria funcionando normalmente até a sucessão.',2,24),(96,'Deixa todo o ambiente pronto para a sucessão sozinho, para evitar despedidas.',4,24),(97,'Os funcionários estavam completamente desfocados sem ninguem no comando.',5,25),(98,'Não havia administração competente dos recursos.',6,25),(99,'Mau aproveitamento do espaço e dá equipe.',3,25),(100,'Acomodação dos funcionários.',2,25);
...
INSERT INTO `institution` VALUES (1,'146','56381708000194','Jessen Vidal','São José',2,0);
...
INSERT INTO `mentor` VALUES (2,'146');
...
INSERT INTO `question` VALUES (5,1),(12,1),(14,1),(16,1),(6,2),(8,2),(9,2),(17,2),(19,2),(23,2),(2,3),(7,3),(10,3),(13,3),(15,3),(18,3),(21,3),(4,4),(11,4),(20,4),(24,4),(25,4),(1,5),(22,5),(3,6);
...
-- Dump completed on 2017-01-28 22:04:27
